...
import type { FooterRender, MenuRender, MultiTabRender, ActiveTabRender } from './renderTypes'
...
const renderSiderMenu = (props: BasicLayoutProps, slots: Slots, matchMenuKeys: string[] = []): VueNodeOrRender => {
...
export default defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    const headerDom = computed(() => headerRender(headerViewProps.value, slots, props.matchMenuKeys))
    ...
    return () => {
      ...
      const activeTabRender = getRender<ActiveTabRender>(props, slots, 'activeTabRender')
      const activeTabDom = activeTabRender && activeTabRender(headerViewProps.value)
      return (
          ...
          <Layout style={{ minHeight: '100%', ...(attrs.style as CSSProperties) }}>
            ...
            <div>
              ...
              <div
                style={{
                  ...genLayoutStyle,
                  marginLeft: isMobile.value ? 0 : !props.collapsed ? '208px' : '48px',
                  marginTop: '48px',
                  zIndex: 1,
