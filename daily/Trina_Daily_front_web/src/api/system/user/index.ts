...
import type { SysUserDTO, SysUserPageParam, SysUserPageVO, SysUserPassDTO, SysUserScope } from '@/api/system/user/types'
 ...
 * @param userId
 */
export function queryUserByWorkId(workId: number) {
  return httpClient.get<ApiResult<SysUserScope>>(`/sysItsUser/useWorkIdQuery?workId=${workId}`)
}
